...
<div class="badges__outer">
    <div class="list__area">
        <div class="list__bar-outer">
            <div class="list__bar">
                <div bug="badges/filtering">
                    <searchable-dropdown id="sort-dropdown"></searchable-dropdown>
                    <button id="ascend-button" class="button square">

                    </button>
                </div>
                <input type="text" class="input" placeholder="Search Badges" id="badge_search" bug="badges/searchbar">
                <div id="display_toggle" class="badges__display-toggles" bug="badges/display-toggles">
        ...
        <div id="spacer" class="">
            ...
            <div id="grid" class="padding badges__grid" bug="badges/grid"></div>
        </div>
    </div>
    ...
    <div class="badges__sidebar" id="badge-sidebar">
        <div class="badges__sidebar-inner">
            ...
            <div class="padding">
                <h1>Users</h1>
                <div id="badge-users-list" class="users-list" bug="badges/users-list">
